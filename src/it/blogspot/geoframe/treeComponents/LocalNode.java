...
public class LocalNode extends Component {
     ...
     * @param[in] entity The entity of the local node
     */
    public LocalNode(final Connections connKeys, final HydroGeoArea entity) {
     ...
     */
    public synchronized HydroGeoPoint getPoint() {
